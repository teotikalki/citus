				  ...
				  bool expectResults)
{
	...
	if (isModificationQuery)
	{
		 ...
		 * connections for tasks that require 2PC is already failed the whole transaction
...
GetPlacementConnectionsReadyForTwoPhaseCommit(List *taskPlacementList)
{
	...
	/* in the second iteration mark the connections as critical and finish the connection establishment */
